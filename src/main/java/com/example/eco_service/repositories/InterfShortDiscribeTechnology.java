...
@Repository
public interface InterfShortDiscribeTechnology extends JpaRepository<ShortDiscribeTechnology, Long>, RevisionRepository<ShortDiscribeTechnology, Long, Integer> {
